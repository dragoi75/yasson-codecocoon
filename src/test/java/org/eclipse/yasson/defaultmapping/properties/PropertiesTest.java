...
public class PropertiesTest {
    ...
    public void testPropertiesWithoutLocale() throws IOException {
        ...
        String message = MessageBundle.getMessage(MessageKeysEnum.PROCESS_FROM_JSON);
    ...
    public void testPropertiesWithLocale() throws IOException {
        ...
        String messageCS = MessageBundle.getMessage(MessageKeysEnum.PROCESS_TO_JSON, new Locale("cs"));
        String templateEN = "Process class: {0} to json using converter: {1}";
        String messageEN = MessageBundle.getMessage(MessageKeysEnum.PROCESS_TO_JSON, new Locale("en"));
    ...
    public void testPropertiesAttributeSetting() throws IOException {
        ...
        String message = MessageBundle.getMessage(MessageKeysEnum.PROCESS_TO_JSON, new Locale("cs"), "Test", "Test1");

...
public class PropertiesTest {
    ...
    public void testPropertiesWithoutLocale() throws IOException {
        ...
        String message = MessageProvider.getMessage(MessageConstants.PROCESS_FROM_JSON);
    ...
    public void testPropertiesWithLocale() throws IOException {
        ...
        String messageCS = MessageProvider.getMessage(MessageConstants.PROCESS_TO_JSON, new Locale("cs"));
        String templateEN = "Process class: {0} to json using converter: {1}";
        String messageEN = MessageProvider.getMessage(MessageConstants.PROCESS_TO_JSON, new Locale("en"));
    ...
    public void testPropertiesAttributeSetting() throws IOException {
        ...
        String message = MessageProvider.getMessage(MessageConstants.PROCESS_TO_JSON, new Locale("cs"), "Test", "Test1");

...
public class ClassParserTest {
    private static final JsonbContextManager jsonbContext = new JsonbContextManager(new JsonbConfig(), JsonProvider.provider());
    private static final ClassIntrospector classParser = new ClassIntrospector(jsonbContext);
    ...
    public void testDefaultMappingFieldModifiers() {
        final JsonbAnnotatedMember<Class<?>> clsElement = introspector.gatherAnnotations(FieldModifiersClass.class);
        ClassDescriptor model = new ClassDescriptor(FieldModifiersClass.class, introspector.buildClassCustomization(clsElement), null, null);
        classParser.collectProperties(model, clsElement);
    ...
    public void testDefaultMappingMethodModifiers() {
        final JsonbAnnotatedMember<Class<?>> clsElement = introspector.gatherAnnotations(MethodModifiersClass.class);
        ClassDescriptor model = new ClassDescriptor(FieldModifiersClass.class, introspector.buildClassCustomization(clsElement), null, null);
        classParser.collectProperties(model, clsElement);

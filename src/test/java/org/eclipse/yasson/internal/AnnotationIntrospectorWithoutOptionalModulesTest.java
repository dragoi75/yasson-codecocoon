...
public class AnnotationIntrospectorWithoutOptionalModulesTest {
     ...
     * class under test.
     */
    private static final JsonbAnnotationIntrospector instrospector = new JsonbAnnotationIntrospector(new JsonbContextManager(new JsonbConfig(), JsonProvider.provider()));

 ...
 */
public interface JsonbCursor extends JsonParser {

    /**
     * Moves parser to required event, if current event is equal to required does nothing.
     *
     * @param entry Required event.
     */
    void moveTo(JsonParser.Event entry);
     ...
     */
    JsonbStreamingParser.LevelParseContext getCurrentLevel();

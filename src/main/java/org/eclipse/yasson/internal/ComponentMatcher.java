...
public class ComponentMatcher {
    ...
    AdapterBinding introspectAdapterBinding(Class<? extends JsonbAdapter> adapterClass, JsonbAdapter instance) {
        final ParameterizedType adapterRuntimeType = ReflectionHelper.findParameterizedInterfaceType(adapterClass, JsonbAdapter.class);
    ...
    SerializerBinding introspectSerializerBinding(Class<? extends JsonbSerializer> serializerClass, JsonbSerializer instance) {
        final ParameterizedType serializerRuntimeType = ReflectionHelper.findParameterizedInterfaceType(serializerClass, JsonbSerializer.class);

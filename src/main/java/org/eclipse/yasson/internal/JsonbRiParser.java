...
public class JsonbRiParser implements JsonParser, JsonbParser {
    ...
    public void moveTo(JsonParser.Event required) {
        ...
        throw new JsonbException(Messages.getMessage(MessageConstants.INTERNAL_ERROR, "Event " + required + " not found." + getLastDataMsg()));
    }
    ...
    private Event moveTo(Event... events) {
        ...
        throw new JsonbException(Messages.getMessage(MessageConstants.INTERNAL_ERROR, "Parser event ["+Arrays.toString(events)+"] not found." + getLastDataMsg()));
    }

...
public class PropertyModel implements Comparable<PropertyModel> {
    ...
    private JsonbSerializer<?> resolveCachedSerializer() {
        ...
        final Optional<SerializerProviderWrapper> valueSerializerProvider = DefaultSerializerRegistry.getInstance().getValueSerializerProvider(propertyRawType);
    ...
    private AdapterBinding getUserAdapterBinding(Property property, JsonbRuntimeContext jsonbContext) {

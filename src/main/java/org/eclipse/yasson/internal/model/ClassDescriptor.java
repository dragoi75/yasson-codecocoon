...
public class ClassDescriptor {
     ...
     */
    public ClassDescriptor(Class<?> targetClass, ClassSerializationConfig serializationConfig, ClassDescriptor parentDescriptor, PropertyNamingStrategy namingStrategy) {

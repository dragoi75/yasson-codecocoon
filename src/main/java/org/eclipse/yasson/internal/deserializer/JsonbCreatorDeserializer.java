...
class JsonbCreatorDeserializer implements ModelUnmarshaller<JsonParser> {
    ...
    JsonbCreatorDeserializer(Map<String, ModelUnmarshaller<JsonParser>> propertyDeserializerChains, Map<String, ModelUnmarshaller<Object>> defaultCreatorValues, JsonbCreator creator, Class<?> clazz, Function<String, String> renamer, boolean failOnUnknownProperties, Set<String> ignoredProperties) {

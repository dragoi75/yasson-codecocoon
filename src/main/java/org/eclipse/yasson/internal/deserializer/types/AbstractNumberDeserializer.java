    ...
    private ModelUnmarshaller<String> actualDeserializer(TypeDeserializerBuilder builder) {
        ...
        if (null == customization.getDeserializeNumberFormatter()) {
            return (value, context) -> {
                try {
                    ...
                    throw new JsonbException(MessageBundle.getMessage(MessageKeyConstants.DESERIALIZE_VALUE_ERROR, getType()), e);
                }
            };
        }
        ...
        return (value, context) -> {
            try {
                ...
                throw new JsonbException(MessageBundle.getMessage(MessageKeyConstants.PARSING_NUMBER, value, numberFormat.getFormat()), e);
            }
        };
    }

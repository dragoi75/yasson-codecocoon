...
public class TypeDeserializers {
    ...
    private static ModelUnmarshaller<JsonParser> assignableCases(TypeDeserializerBuilder builder, JsonParser.Event[] checker) {
     ...
     */
    public static ModelUnmarshaller<JsonParser> getTypeDeserializer(Class<?> clazz, Customization customization, JsonbConfigProperties properties, ModelUnmarshaller<Object> delegate, Set<JsonParser.Event> events) {

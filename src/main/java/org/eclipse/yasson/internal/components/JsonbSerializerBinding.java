 ...
 */
public class JsonbSerializerBinding<T> extends AbstractComponentBinding {
     ...
     * @param serializer Serializer. Can be null.
     */
    public JsonbSerializerBinding(Type targetType, JsonbSerializer<T> serializer) {
        super(targetType);

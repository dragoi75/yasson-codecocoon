...
public class JsonbComponentInstanceCreatorFactory {
    ...
    private static Object getJndiBeanManager() {
        return AccessController.doPrivileged((PrivilegedAction<Object>) () -> {
            try {
                ...
                log.finest(MessageBundle.getMessage(MessageKey.NO_JNDI_ENVIRONMENT, INITIAL_CONTEXT_CLASS));
                return null;
            }
        });
    }
    ...
    private static Object getBeanManager(BeanManagerProvider command) throws ClassNotFoundException {
        try {
            ...
            log.warning(MessageBundle.getMessage(MessageKey.ILLEGAL_ACCESS, "lookup CDI bean manager"));
            return null;
            ...
            log.finest(MessageBundle.getMessage(MessageKey.NO_CDI_ENVIRONMENT));
            return null;
        }
    }
    ...
    private static Object getCdiBeanManager() {
        return AccessController.doPrivileged((PrivilegedAction<Object>) () -> {
            try {
                ...
                log.finest(MessageBundle.getMessage(MessageKey.NO_CDI_API_PROVIDER, CDI_SPI_CLASS));
                return null;
            }
        });
    }
    ...
    public static JsonbComponentInstanceCreator getComponentInstanceCreator(InstanceCreator creator) {
        ...
        if (null == beanManager) {
            log.finest(MessageBundle.getMessage(MessageKey.BEAN_MANAGER_NOT_FOUND_USING_DEFAULT));

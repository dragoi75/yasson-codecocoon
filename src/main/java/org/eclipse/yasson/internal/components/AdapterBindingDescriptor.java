 ...
 */
public class AdapterBindingDescriptor extends AbstractComponentBinding {
     ...
     * @param jsonbConverter components not null
     */
    public AdapterBindingDescriptor(Type sourceType, Type targetType, JsonbAdapter<?, ?> jsonbConverter) {
        super(sourceType);
        Objects.requireNonNull(targetType);
        Objects.requireNonNull(jsonbConverter);

...
public class JsonGeneratorToStructureAdapter implements JsonGenerator {
    ...
    private JsonObjectBuilder getJsonObjectBuilder(String keyName) {
        ...
        if (!(current instanceof JsonObjectBuilder)) {
            throw new JsonbException(MessageProvider.getMessage(MessageConstants.INTERNAL_ERROR, "Can't write key [" + keyName + "] into " + current.getClass() + "because " + current.getClass() + " is not an instance of " + JsonObjectBuilder.class));
        }

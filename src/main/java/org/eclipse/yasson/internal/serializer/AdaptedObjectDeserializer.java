...
public class AdaptedObjectDeserializer<A, T> implements CurrentItem<T>, JsonbDeserializer<T> {
    ...
    private final ContainerDeserializerBase<?> wrapperItem;
    ...
    public Type getRuntimeType() {
        if (adaptedTypeDeserializer instanceof ContainerDeserializerBase) {
            return ((ContainerDeserializerBase) adaptedTypeDeserializer).getRuntimeType();
        }
     ...
     */
    public AdaptedObjectDeserializer(AdapterBinding adapterInfo, ContainerDeserializerBase<?> wrapperItem) {

 ...
 */
public class ByteArrayDeserializerImpl extends AbstractArrayDeserializer<byte[]> {
    ...
    protected ByteArrayDeserializerImpl(JsonValueDeserializerBuilder deserializerFactory) {

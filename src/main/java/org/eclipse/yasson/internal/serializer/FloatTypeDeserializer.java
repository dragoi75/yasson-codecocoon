...
public class FloatTypeDeserializer extends AbstractNumberDeserializer<Float> {
    ...
    @Override
    protected Float deserializeInstance(String jsonValue, Unmarshaller unmarshaller, Type rtType) {
        return deserializeFormatted(jsonValue, false, unmarshaller.getJsonbContext())
                ...
                .orElseGet(() -> {
                    try {
                        ...
                        throw new JsonbException(LocalizedMessages.getMessage(MessageConstants.DESERIALIZE_VALUE_ERROR, Float.class));
                    }
                });
    }

 ...
 */
public class OptionalIntTypeSerializer extends AbstractValueSerializer<OptionalInt> {

    @Override
    protected void serializeValue(OptionalInt obj, JsonGenerator generator, JsonbMarshaller marshaller) {

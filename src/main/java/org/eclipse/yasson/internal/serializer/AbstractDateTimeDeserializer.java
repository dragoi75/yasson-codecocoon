...
public abstract class AbstractDateTimeDeserializer<T> extends BaseValueTypeDeserializer<T> {
    ...
    @Override
    public T deserializeInstance(String jsonValue, Unmarshaller unmarshaller, Type rtType) {
        ...
        try {
            ...
            throw new JsonbException(LocalizedMessages.getMessage(MessageConstants.DATE_PARSE_ERROR, jsonValue, getPropertyType()), e);
        }
    }

...
public abstract class AbstractDateTimeSerializer<T> extends AbstractValueTypeSerializer<T> {
    ...
    public void serialize(T obj, JsonGenerator generator, SerializationContext ctx) {
        final JsonbContextManager jsonbContext = ((Marshaller) ctx).getJsonbContext();
     ...
     */
    public String toJson(T object, JsonbDateFormatter formatter, JsonbContextManager jsonbContext) {
     ...
     */
    protected JsonbDateFormatter getJsonbDateFormatter(JsonbContextManager context) {

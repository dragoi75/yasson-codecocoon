...
public abstract class AbstractContainerDeserializer<T> extends AbstractItem<T> implements JsonbDeserializer<T> {
     ...
     */
    protected AbstractContainerDeserializer(JsonDeserializerBuilder builder) {
        super(builder);
    }
    ...
    protected JsonDeserializerBuilder newUnmarshallerItemBuilder(JsonbContext ctx) {
        return new JsonDeserializerBuilder(ctx).withWrapper(this).withJsonEvent(parserContext.getLastEvent());
    }
    ...
    protected JsonbDeserializer<?> newCollectionOrMapItem(Type valueType, JsonbContext ctx) {
        ...
        JsonDeserializerBuilder deserializerBuilder = newUnmarshallerItemBuilder(ctx).withType(actualValueType);

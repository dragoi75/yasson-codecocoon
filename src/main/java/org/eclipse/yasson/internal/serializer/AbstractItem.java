 ...
 */
public abstract class AbstractItem<T> implements ActiveItemModel<T> {
     ...
     */
    public AbstractItem(ActiveItemModel<?> wrapper, Type runtimeType, ClassDescriptor classModel) {

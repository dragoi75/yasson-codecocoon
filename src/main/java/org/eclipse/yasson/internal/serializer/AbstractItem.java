 ...
 */
public abstract class AbstractItem<T> implements CurrentItemWrapper<T> {

    /**
     * Item containing instance of wrapping object and its metadata.
     * Null in case of a root object.
     */
    private final CurrentItemWrapper<?> wrapper;
     ...
     */
    public AbstractItem(CurrentItemWrapper<?> wrapper, Type runtimeType, ClassDescriptor classModel) {

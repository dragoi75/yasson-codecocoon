...
public class ShortTypeDeserializer extends AbstractNumberDeserializer<Short> {
    ...
    @Override
    protected Short deserializeInstance(String jsonValue, Unmarshaller unmarshaller, Type rtType) {
        return deserializeFormatted(jsonValue, true, unmarshaller.getJsonbContext())
                ...
                .orElseGet(() -> {
                    try {
                        ...
                        throw new JsonbException(LocalizedMessages.getMessage(MessageConstants.DESERIALIZE_VALUE_ERROR, Short.class));
                    }
                });
    }

 ...
 */
public class PrimitiveShortArrayDeserializer extends AbstractArrayDeserializer<short[]> {
    ...
    public short[] getInstance(Unmarshaller unmarshaller) {
        ...
        final short[] shortValues = new short[length];
        int index = 0;
        while (length > index) {
            shortValues[index] = shortList.get(index);
            index += 1;
        }
        return shortValues;
    }

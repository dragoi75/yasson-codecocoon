 ...
 */
public class JsonObjectConverter extends AbstractJsonpDeserializer<JsonObject> {
     ...
     */
    protected JsonObjectConverter(JsonbDeserializerBuilder deserializerFactory) {

...
public class JsonbDateTimeFormatter {
    ...
    private static final JsonbDateTimeFormatter STANDARD_JSONB_DATE_TIME_FORMATTER = new JsonbDateTimeFormatter(JsonbDateFormat.DEFAULT_FORMAT, Locale.getDefault().toLanguageTag());

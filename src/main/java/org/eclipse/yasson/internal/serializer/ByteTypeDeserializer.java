...
public class ByteTypeDeserializer extends AbstractNumberDeserializer<Byte> {
    ...
    @Override
    protected Byte deserializeInstance(String value, Unmarshaller unmarshaller, Type rtType) {
        return deserializeFormatted(value, true, unmarshaller.getJsonbContext())
                ...
                .orElseGet(() -> {
                    try {
                        ...
                        throw new JsonbException(LocalizedMessages.getMessage(MessageConstants.DESERIALIZE_VALUE_ERROR, Byte.class));
                    }
                });
    }
}

 ...
 * @author David Kral
 */
public class NumberTypeSerializer extends ValueTypeSerializerBase<Number> {
    ...
    @Override
    protected void serializeValue(Number obj, JsonGenerator generator, ObjectMarshaller marshaller) {

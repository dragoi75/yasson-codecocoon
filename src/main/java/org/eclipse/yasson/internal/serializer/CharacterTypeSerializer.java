 ...
 * @author David Kral
 */
public class CharacterTypeSerializer extends ValueTypeSerializerBase<Character> {
    ...
    @Override
    protected void serializeValue(Character obj, JsonGenerator generator, ObjectMarshaller marshaller) {

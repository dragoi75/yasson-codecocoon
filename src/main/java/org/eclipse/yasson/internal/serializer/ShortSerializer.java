...
public class ShortSerializer extends AbstractNumberSerializer<Short> {
     ...
     *
     * @param formatConfig Model customization.
     */
    public ShortSerializer(Customization formatConfig) {
        super(formatConfig);
    }

    @Override
    protected void serializeNonFormatted(Short shortValue, JsonGenerator jsonWriter, String propertyName) {

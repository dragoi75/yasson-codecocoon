...
class AnnotationFinder {
    ...
    private Object invocateValueMethod(Annotation annotation) {
        ...
        try {
            ...
            String message = ResourceBundleMessages.getMessage(MessageConstants.MISSING_VALUE_PROPERTY_IN_ANNOTATION, annotation.annotationType().getName());
    ...
    private static <T extends Annotation> Class<T> getOptionalAnnotationClass(String classname) {
        try {
            ...
            String message = ResourceBundleMessages.getMessage(MessageConstants.ANNOTATION_NOT_AVAILABLE, classname);
            LOGGER.finest(message);
            return null;
        }
    }

...
class AnnotationFinder {
    ...
    private Object invocateValueMethod(Annotation annotation) {
        ...
        try {
            ...
            String message = Messages.getMessage(MessageKeyConstants.MISSING_VALUE_PROPERTY_IN_ANNOTATION, annotation.annotationType().getName());
    ...
    private static <T extends Annotation> Class<T> getOptionalAnnotationClass(String classname) {
        try {
            ...
            String message = Messages.getMessage(MessageKeyConstants.ANNOTATION_NOT_AVAILABLE, classname);
            LOGGER.finest(message);
            return null;
        }
    }

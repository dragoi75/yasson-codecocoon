...
class AnnotationFinder {
    ...
    private static <T extends Annotation> Class<T> getOptionalAnnotationClass(String classname) {
        try {
            ...
            String message = LocalizedMessages.getMessage(MessageKeyConstants.ANNOTATION_NOT_AVAILABLE, classname);
    ...
    private Object invocateValueMethod(Annotation annotation) {
        ...
        try {
            ...
            String message = LocalizedMessages.getMessage(MessageKeyConstants.MISSING_VALUE_PROPERTY_IN_ANNOTATION, annotation.annotationType().getName());
            LOGGER.finest(message);
            return null;
        }
    }

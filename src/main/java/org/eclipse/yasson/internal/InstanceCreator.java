...
public class InstanceCreator {
    ...
    private static final class ConstructorCreator implements Creator {
        ...
        public Object createInstance() {
            return ReflectiveTypeUtils.instantiateNoArgConstructor(constructor);
        }
    }
    ...
    public <T> T createInstance(Class<T> tClass) {
        ...
        if (null == creator) {
            creator = new ConstructorCreator(ReflectiveTypeUtils.getDefaultConstructor(tClass, true));
